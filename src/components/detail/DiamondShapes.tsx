...
export function DiamondShapes() {
  return (
    <section id="shapes" style={{ padding: '100px 48px', maxWidth: 1280, margin: '0 auto' }}>
      <motion.div
      ...
      >
        ...
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 300, fontSize: 'clamp(30px, 4.2vw, 50px)', color: 'var(--text)', lineHeight: 1.05 }}>
          Choose Your Silhouette
        </h2>
        <p style={{ maxWidth: 540, margin: '16px auto 0', color: 'var(--text-soft)', fontWeight: 300, fontSize: 15, lineHeight: 1.8 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 1, background: 'var(--line)', border: '1px solid var(--line)' }}>
        {shapes.map((s, i) => (
          <motion.div
            ...
            style={{ background: 'var(--surface)', padding: '38px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, transition: 'background 0.5s ease' }}
